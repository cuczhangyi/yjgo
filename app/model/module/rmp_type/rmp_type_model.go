...
// 生成路径: app/model/module/rmp_type/rmp_type_model.go
// 生成人：张一
// ==========================================================================
...
// arModel is a active record design model for table rmp_type operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of rmp_type.
	Table = "rmp_type"
	// Model is the model object of rmp_type.
