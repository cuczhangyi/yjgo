...
// 生成路径: app/model/module/rmp_file/rmp_file_model.go
// 生成人：张大方
// ==========================================================================
...
// arModel is a active record design model for table rmp_file operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of rmp_file.
	Table = "rmp_file"
	// Model is the model object of rmp_file.
