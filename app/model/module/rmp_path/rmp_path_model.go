...
// 生成路径: app/model/module/rmp_path/rmp_path_model.go
// 生成人：yunjie
// ==========================================================================
...
// arModel is a active record design model for table rmp_path operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of rmp_path.
	Table = "rmp_path"
	// Model is the model object of rmp_path.
