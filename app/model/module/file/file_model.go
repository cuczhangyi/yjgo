...
// 生成路径: app/model/module/file/file_model.go
// 生成人：yunjie
// ==========================================================================
...
// arModel is a active record design model for table tbl_file operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of tbl_file.
	Table = "tbl_file"
	// Model is the model object of tbl_file.
