...
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='代码生成业务表';
...
INSERT INTO `gen_table` VALUES ('60', 'rmp_file', '资源文件', 'rmp_file', 'crud', 'yj-app', 'module', 'rmp_file', '资源文件', '张大方', '', 'admin', '2020-05-18 17:22:57', 'admin', '2020-05-18 17:24:48', '');
...
) ENGINE=InnoDB AUTO_INCREMENT=650 DEFAULT CHARSET=utf8 COMMENT='代码生成业务表字段';
...
INSERT INTO `gen_table_column` VALUES ('632', '60', 'id', '文件id', 'int(11)', 'int64', 'Id', 'id', '1', '1', '0', '1', '0', '0', '0', 'EQ', 'input', '', '1', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('633', '60', 'file_name', '文件名称', 'char(40)', 'string', 'FileName', 'fileName', '0', '0', '1', '1', '1', '1', '1', 'LIKE', 'input', '', '2', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('634', '60', 'file_ext', '文件后缀名', 'varchar(256)', 'string', 'FileExt', 'fileExt', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', '3', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('635', '60', 'store_list', '存储位置', 'longtext', 'string', 'StoreList', 'storeList', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'textarea', '', '4', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('636', '60', 'prev_file_pic', '预览图片', 'varchar(256)', 'string', 'PrevFilePic', 'prevFilePic', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', '5', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('637', '60', 'prev_file_video', '预览视频', 'varchar(256)', 'string', 'PrevFileVideo', 'prevFileVideo', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', '6', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('638', '60', 'rmp_type_id', '资源类型', 'int(11)', 'int64', 'RmpTypeId', 'rmpTypeId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', '7', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('639', '60', 'meta_data', 'meta_data', 'text', 'string', 'MetaData', 'metaData', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'textarea', '', '8', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('640', '60', 'path_id', '路径id', 'int(11)', 'int64', 'PathId', 'pathId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', '9', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('641', '60', 'is_package', '是否为文件包（0不是 1是）', 'char(1)', 'string', 'IsPackage', 'isPackage', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'radio', 'sys_yes_no', '10', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('642', '60', 'parent_id', '父级文件id(文件包专用)', 'int(11)', 'int64', 'ParentId', 'parentId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', '11', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('643', '60', 'status', '文件状态（0正常 00000001自身停用, 00000010父级停用, 00000100分类停用, 00001000路径停用）', 'int(11)', 'int64', 'Status', 'status', '0', '0', '1', '1', '1', '1', '1', 'EQ', 'radio', '', '12', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('644', '60', 'del_flag', '删除标志（0正常 00000001自身删除, 00000010父级删除, 00000100分类删除, 00001000路径删除）', 'int(11)', 'int64', 'DelFlag', 'delFlag', '0', '0', '0', '1', '0', '0', '0', 'EQ', 'input', '', '13', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('645', '60', 'create_by', '创建者', 'varchar(64)', 'string', 'CreateBy', 'createBy', '0', '0', '0', '0', '0', '0', '0', 'EQ', 'input', '', '14', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('646', '60', 'create_time', '创建时间', 'datetime', 'Time', 'CreateTime', 'createTime', '0', '0', '0', '0', '0', '0', '0', 'EQ', 'input', '', '15', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('647', '60', 'update_by', '更新者', 'varchar(64)', 'string', 'UpdateBy', 'updateBy', '0', '0', '0', '0', '0', '0', '0', 'EQ', 'input', '', '16', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('648', '60', 'update_time', '更新时间', 'datetime', 'Time', 'UpdateTime', 'updateTime', '0', '0', '0', '0', '0', '0', '0', 'EQ', 'input', '', '17', 'admin', null, '', null);
INSERT INTO `gen_table_column` VALUES ('649', '60', 'remark', '备注', 'varchar(255)', 'string', 'Remark', 'remark', '0', '0', '0', '1', '1', '1', '0', 'EQ', 'input', '', '18', 'admin', null, '', null);
...
CREATE TABLE `rmp_file` (
  ...
  `is_package` char(1) NOT NULL DEFAULT '0' COMMENT '是否为文件包（0不是 1是）',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT '父级文件id(文件包专用)',
  `status` int(11) NOT NULL DEFAULT '0' COMMENT '文件状态（0正常 00000001自身停用, 00000010父级停用, 00000100分类停用, 00001000路径停用）',
  `del_flag` int(11) NOT NULL DEFAULT '0' COMMENT '删除标志（0正常 00000001自身删除, 00000010父级删除, 00000100分类删除, 00001000路径删除）',
  `create_by` varchar(64) DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='资源文件';

-- ----------------------------
-- Records of rmp_file
-- ----------------------------
INSERT INTO `rmp_file` VALUES ('1', 'test.png', 'png', '', '', '', '1', '[{\"name\":\"城市\",\"code\":\"city\",\"values\":\"1,343\"},{\"name\":\"学校\",\"code\":\"school\",\"values\":\"\"}]', '100000', '1', '0', '0', '0', '', null, '', null, null);
INSERT INTO `rmp_file` VALUES ('2', 'test.bmp', 'bmp', null, '', '', '1', ' ', '100000', '0', '1', '0', '0', '', null, '', null, null);
INSERT INTO `rmp_file` VALUES ('3', 'test1.png', 'png', '', '', '', '1', ' ', '100000', '1', '1', '0', '0', '', '2020-05-19 15:07:55', '', '2020-05-19 15:08:02', '');
INSERT INTO `rmp_file` VALUES ('4', 'test5.png', 'png', '', '', '', '1', ' ', '100000', '0', '0', '0', '0', '', '2020-05-19 15:08:38', '', '2020-05-19 15:08:40', '');
INSERT INTO `rmp_file` VALUES ('5', '无标题 - 副本.png', '.png', '2020-05-22/c2x170ier8as855427.png', '2020-05-22/c2x17l04ra7g961637.png', '2020-05-22/c2x17olys25g253913.mp4', '2', '[]', '100000', '0', '0', '0', '0', '1', '2020-05-22 14:39:55', '', null, null);
INSERT INTO `rmp_file` VALUES ('6', '23123', '.png', '2020-05-22/c2x219cgzwco919906.png', '2020-05-22/c2x20vogiy8k895965.png', '2020-05-22/c2x212mcffl8508683.mp4', '2', '[]', '100000', '0', '0', '0', '0', '1', '2020-05-22 14:48:04', '', null, null);
INSERT INTO `rmp_file` VALUES ('7', '23123', '.png', '2020-05-22/c2x219cgzwco919906.png', '2020-05-22/c2x20vogiy8k895965.png', '2020-05-22/c2x212mcffl8508683.mp4', '2', '[]', '100000', '0', '0', '0', '0', '1', '2020-05-22 14:49:55', '', null, null);
...
INSERT INTO `sys_logininfor` VALUES ('121', 'admin', '[::1]', '内网IP', 'Chrome', 'Windows 10', '0', '登陆成功', '2020-05-18 17:32:28');
INSERT INTO `sys_logininfor` VALUES ('122', 'admin', '[::1]', '内网IP', 'Chrome', 'Windows 10', '0', '登陆成功', '2020-05-18 18:12:09');
INSERT INTO `sys_logininfor` VALUES ('123', 'admin', '[::1]', '内网IP', 'Chrome', 'Windows 10', '0', '登陆成功', '2020-05-22 10:08:23');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1104 DEFAULT CHARSET=utf8 COMMENT='菜单权限表';
...
INSERT INTO `sys_menu` VALUES ('1098', '资源文件', '4', '1', '/module/rmp_file', '', 'C', '0', 'module:rmp_file:view', '#', 'admin', '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', '资源文件菜单');
INSERT INTO `sys_menu` VALUES ('1099', '资源文件查询', '1098', '1', '#', '', 'F', '0', 'module:rmp_file:list', '#', 'admin', '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('1100', '资源文件新增', '1098', '2', '#', '', 'F', '0', 'module:rmp_file:add', '#', 'admin', '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('1101', '资源文件修改', '1098', '3', '#', '', 'F', '0', 'module:rmp_file:edit', '#', 'admin', '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('1102', '资源文件删除', '1098', '4', '#', '', 'F', '0', 'module:rmp_file:remove', '#', 'admin', '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('1103', '资源文件导出', '1098', '5', '#', '', 'F', '0', 'module:rmp_file:export', '#', 'admin', '2020-01-01 00:00:00', 'admin', '2020-01-01 00:00:00', '');
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=497 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
...
INSERT INTO `sys_oper_log` VALUES ('444', '导入表结构', '0', '/tool/gen/importTable', 'POST', '1', 'admin', '', '/tool/gen/importTable', '[::1]', '内网IP', '{\"tables\":\"rmp_file\"}', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-18 17:22:57');
INSERT INTO `sys_oper_log` VALUES ('445', '生成代码', '2', '/tool/gen/edit', 'POST', '1', 'admin', '', '/tool/gen/edit', '[::1]', '内网IP', '{\"tableName\":\"rmp_file\"}', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":2}', '0', '', '2020-05-18 17:24:48');
INSERT INTO `sys_oper_log` VALUES ('446', '生成代码', '0', '/tool/gen/genCode?tableId=60', 'GET', '1', 'admin', '', '/tool/gen/genCode?tableId=60', '[::1]', '内网IP', '{\"tableId\":60}', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-18 17:27:15');
INSERT INTO `sys_oper_log` VALUES ('447', '生成代码', '0', '/tool/gen/genCode?tableId=60', 'GET', '1', 'admin', '', '/tool/gen/genCode?tableId=60', '[::1]', '内网IP', '{\"tableId\":60}', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-18 17:27:49');
INSERT INTO `sys_oper_log` VALUES ('448', '新增用户', '1', '/system/user/add', 'POST', '1', 'admin', '', '/system/user/add', '[::1]', '内网IP', '{\"UserName\":\"11\",\"Phonenumber\":\"15342050992\",\"Email\":\"jam@gmail.com\",\"LoginName\":\"123456\",\"Password\":\"1234567\",\"DeptId\":112,\"Sex\":\"0\",\"Status\":\"0\",\"RoleIds\":\"1,7\",\"PostIds\":\"2\",\"Remark\":\"\"}', '{\"code\":500,\"msg\":\"用户名称长度为5到30位\",\"data\":null,\"otype\":1}', '1', '', '2020-05-20 17:33:50');
INSERT INTO `sys_oper_log` VALUES ('449', '新增用户', '1', '/system/user/add', 'POST', '1', 'admin', '', '/system/user/add', '[::1]', '内网IP', '{\"UserName\":\"123456\",\"Phonenumber\":\"15342050992\",\"Email\":\"jam@gmail.com\",\"LoginName\":\"123456\",\"Password\":\"1234567\",\"DeptId\":112,\"Sex\":\"0\",\"Status\":\"0\",\"RoleIds\":\"1,7\",\"PostIds\":\"2\",\"Remark\":\"\"}', '{\"code\":0,\"msg\":\"操作成功\",\"data\":5,\"otype\":1}', '0', '', '2020-05-20 17:33:56');
INSERT INTO `sys_oper_log` VALUES ('450', '岗位管理', '2', '/system/post/edit', 'POST', '1', 'admin', '', '/system/post/edit', '[::1]', '内网IP', '{\"PostId\":1,\"PostName\":\"董事长\",\"PostCode\":\"ceo\",\"PostSort\":1,\"Status\":\"1\",\"Remark\":\"4223434\"}', '{\"code\":0,\"msg\":\"操作成功\",\"data\":1,\"otype\":2}', '0', '', '2020-05-20 17:35:59');
INSERT INTO `sys_oper_log` VALUES ('451', '岗位管理', '1', '/system/post/add', 'POST', '1', 'admin', '', '/system/post/add', '[::1]', '内网IP', '{\"PostName\":\"232\",\"PostCode\":\"22\",\"PostSort\":22222,\"Status\":\"0\",\"Remark\":\"2222222222\"}', '{\"code\":500,\"msg\":\"操作失败\",\"data\":3,\"otype\":1}', '1', '', '2020-05-20 17:36:17');
INSERT INTO `sys_oper_log` VALUES ('452', '岗位管理', '1', '/system/post/add', 'POST', '1', 'admin', '', '/system/post/add', '[::1]', '内网IP', '{\"PostName\":\"232\",\"PostCode\":\"调度\",\"PostSort\":22222,\"Status\":\"0\",\"Remark\":\"2222222222\"}', '{\"code\":500,\"msg\":\"岗位名称已存在\",\"data\":null,\"otype\":1}', '1', '', '2020-05-20 17:36:23');
INSERT INTO `sys_oper_log` VALUES ('453', '岗位管理', '1', '/system/post/add', 'POST', '1', 'admin', '', '/system/post/add', '[::1]', '内网IP', '{\"PostName\":\"4444\",\"PostCode\":\"调度\",\"PostSort\":22222,\"Status\":\"0\",\"Remark\":\"2222222222\"}', '{\"code\":500,\"msg\":\"操作失败\",\"data\":4,\"otype\":1}', '1', '', '2020-05-20 17:36:30');
INSERT INTO `sys_oper_log` VALUES ('454', '角色管理', '1', '/system/role/add', 'POST', '1', 'admin', '', '/system/role/add', '[::1]', '内网IP', '{\"RoleName\":\"管事的\",\"RoleKey\":\"user\",\"RoleSort\":\"1\",\"Status\":\"0\",\"Remark\":\"1\",\"MenuIds\":\"1,100,1000,1001,1002,1003,1004,1005,1006,101,1007,1008,1009,1010,1011,102,1012,1013,1014,1015,103,1016,1017,1018,1019,104,1020,1021,1022,1023,1024,105,1025,1026,1027,1028,1029,106,1030,1031,1032,1033,1034,107,1035,1036,1037,1038,4,1086,1087,1088,1089,1090,1091,1092,1093,1094,1095,1096,1097,1098,1099,1100,1101,1102,1103,2,109,1047,1048,1049,110,1050,1051,1052,1053,1054,1055,1056,112,500,1039,1040,1041,1042,501,1043,1044,1045,1046\"}', '{\"code\":0,\"msg\":\"操作成功\",\"data\":8,\"otype\":1}', '0', '', '2020-05-20 17:37:09');
INSERT INTO `sys_oper_log` VALUES ('455', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-21 15:04:50');
INSERT INTO `sys_oper_log` VALUES ('456', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-21 15:08:23');
INSERT INTO `sys_oper_log` VALUES ('457', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-21 15:17:26');
INSERT INTO `sys_oper_log` VALUES ('458', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-21 15:18:33');
INSERT INTO `sys_oper_log` VALUES ('459', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-21 15:19:44');
INSERT INTO `sys_oper_log` VALUES ('460', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-21 15:21:17');
INSERT INTO `sys_oper_log` VALUES ('461', '上传文件成功', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-21 16:44:47');
INSERT INTO `sys_oper_log` VALUES ('462', '上传文件成功', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-21 16:47:59');
INSERT INTO `sys_oper_log` VALUES ('463', '上传文件成功', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-21 17:01:53');
INSERT INTO `sys_oper_log` VALUES ('464', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 10:10:48');
INSERT INTO `sys_oper_log` VALUES ('465', '上传文件成功', '0', '/module/rmp_file/uploadprevpic', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevpic', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 10:10:51');
INSERT INTO `sys_oper_log` VALUES ('466', '上传文件成功', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 10:11:02');
INSERT INTO `sys_oper_log` VALUES ('467', '上传文件成功', '0', '/module/rmp_file/uploadprevpic', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevpic', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 12:22:11');
INSERT INTO `sys_oper_log` VALUES ('468', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 12:22:36');
INSERT INTO `sys_oper_log` VALUES ('469', '上传文件成功', '0', '/module/rmp_file/uploadprevpic', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevpic', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 12:27:20');
INSERT INTO `sys_oper_log` VALUES ('470', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 12:27:34');
INSERT INTO `sys_oper_log` VALUES ('471', '上传文件成功', '0', '/module/rmp_file/uploadprevpic', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevpic', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 12:30:07');
INSERT INTO `sys_oper_log` VALUES ('472', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 12:30:14');
INSERT INTO `sys_oper_log` VALUES ('473', '上传文件失败', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":0}', '1', '', '2020-05-22 12:30:21');
INSERT INTO `sys_oper_log` VALUES ('474', '上传文件成功', '0', '/module/rmp_file/uploadprevpic', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevpic', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 12:38:33');
INSERT INTO `sys_oper_log` VALUES ('475', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 12:38:38');
INSERT INTO `sys_oper_log` VALUES ('476', '上传文件失败', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":0}', '1', '', '2020-05-22 12:38:43');
INSERT INTO `sys_oper_log` VALUES ('477', '资源文件新增数据', '1', '/module/rmp_file/add', 'POST', '1', 'admin', '', '/module/rmp_file/add', '[::1]', '内网IP', '{\"FileName\":\"222\",\"FileExt\":\"\",\"StoreList\":\"\",\"PrevFilePic\":\"c2wzbe21nixc227543.png\",\"PrevFileVideo\":\"c2wzbgctpvtg642498.mp4\",\"RmpTypeId\":2,\"MetaData\":\"\",\"PathId\":100000,\"IsPackage\":\"\",\"ParentId\":0,\"Status\":0,\"DelFlag\":0,\"Remark\":\"\",\"Rmpfile\":\"\"}', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":1}', '1', '', '2020-05-22 13:59:30');
INSERT INTO `sys_oper_log` VALUES ('478', '上传文件失败', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":0}', '1', '', '2020-05-22 14:00:19');
INSERT INTO `sys_oper_log` VALUES ('479', '上传文件失败', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":0}', '1', '', '2020-05-22 14:00:35');
INSERT INTO `sys_oper_log` VALUES ('480', '上传文件失败', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":0}', '1', '', '2020-05-22 14:01:33');
INSERT INTO `sys_oper_log` VALUES ('481', '上传文件失败', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":0}', '1', '', '2020-05-22 14:01:33');
INSERT INTO `sys_oper_log` VALUES ('482', '上传文件失败', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":0}', '1', '', '2020-05-22 14:01:56');
INSERT INTO `sys_oper_log` VALUES ('483', '上传文件失败', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":0}', '1', '', '2020-05-22 14:04:14');
INSERT INTO `sys_oper_log` VALUES ('484', '上传文件失败', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":0}', '1', '', '2020-05-22 14:05:06');
INSERT INTO `sys_oper_log` VALUES ('485', '上传文件成功', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 14:07:02');
INSERT INTO `sys_oper_log` VALUES ('486', '上传文件成功', '0', '/module/rmp_file/uploadprevpic', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevpic', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 14:07:36');
INSERT INTO `sys_oper_log` VALUES ('487', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 14:07:45');
INSERT INTO `sys_oper_log` VALUES ('488', '资源文件新增数据', '1', '/module/rmp_file/add', 'POST', '1', 'admin', '', '/module/rmp_file/add', '[::1]', '内网IP', '{\"FileName\":\"无标题 - 副本.png\",\"FileExt\":\"\",\"StoreList\":\"\",\"PrevFilePic\":\"c2x17l04ra7g961637.png\",\"PrevFileVideo\":\"c2x17olys25g253913.mp4\",\"RmpTypeId\":2,\"MetaData\":\"\",\"PathId\":100000,\"IsPackage\":\"\",\"ParentId\":0,\"Status\":0,\"DelFlag\":0,\"Remark\":\"\",\"Rmpfile\":\"c2x170ier8as855427.png\"}', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":1}', '1', '', '2020-05-22 14:08:49');
INSERT INTO `sys_oper_log` VALUES ('489', '资源文件新增数据', '1', '/module/rmp_file/add', 'POST', '1', 'admin', '', '/module/rmp_file/add', '[::1]', '内网IP', '{\"FileName\":\"无标题 - 副本.png\",\"FileExt\":\"\",\"StoreList\":\"\",\"PrevFilePic\":\"c2x17l04ra7g961637.png\",\"PrevFileVideo\":\"c2x17olys25g253913.mp4\",\"RmpTypeId\":2,\"MetaData\":\"\",\"PathId\":100000,\"IsPackage\":\"\",\"ParentId\":0,\"Status\":0,\"DelFlag\":0,\"Remark\":\"\",\"Rmpfile\":\"c2x170ier8as855427.png\"}', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":1}', '1', '', '2020-05-22 14:31:36');
INSERT INTO `sys_oper_log` VALUES ('490', '资源文件新增数据', '1', '/module/rmp_file/add', 'POST', '1', 'admin', '', '/module/rmp_file/add', '[::1]', '内网IP', '{\"FileName\":\"无标题 - 副本.png\",\"FileExt\":\"\",\"StoreList\":\"\",\"PrevFilePic\":\"c2x17l04ra7g961637.png\",\"PrevFileVideo\":\"c2x17olys25g253913.mp4\",\"RmpTypeId\":2,\"MetaData\":\"\",\"PathId\":100000,\"IsPackage\":\"\",\"ParentId\":0,\"Status\":0,\"DelFlag\":0,\"Remark\":\"\",\"Rmpfile\":\"c2x170ier8as855427.png\"}', '{\"code\":500,\"msg\":\"操作失败\",\"data\":null,\"otype\":1}', '1', '', '2020-05-22 14:33:28');
INSERT INTO `sys_oper_log` VALUES ('491', '资源文件新增数据', '0', '/module/rmp_file/add', 'POST', '1', 'admin', '', '/module/rmp_file/add', '[::1]', '内网IP', '{\"FileName\":\"无标题 - 副本.png\",\"FileExt\":\"\",\"StoreList\":\"\",\"PrevFilePic\":\"c2x17l04ra7g961637.png\",\"PrevFileVideo\":\"c2x17olys25g253913.mp4\",\"RmpTypeId\":2,\"MetaData\":\"\",\"PathId\":100000,\"IsPackage\":\"\",\"ParentId\":0,\"Status\":0,\"DelFlag\":0,\"Remark\":\"\",\"Rmpfile\":\"c2x170ier8as855427.png\"}', '{\"code\":0,\"msg\":\"操作成功\",\"data\":5,\"otype\":0}', '0', '', '2020-05-22 14:40:05');
INSERT INTO `sys_oper_log` VALUES ('492', '上传文件成功', '0', '/module/rmp_file/uploadprevpic', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevpic', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 14:45:52');
INSERT INTO `sys_oper_log` VALUES ('493', '上传文件成功', '0', '/module/rmp_file/uploadprevvideo', 'POST', '1', 'admin', '', '/module/rmp_file/uploadprevvideo', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 14:46:08');
INSERT INTO `sys_oper_log` VALUES ('494', '上传文件成功', '0', '/module/rmp_file/uploadrmpfile', 'POST', '1', 'admin', '', '/module/rmp_file/uploadrmpfile', '[::1]', '内网IP', '\"\"', '{\"code\":0,\"msg\":\"操作成功\",\"data\":null,\"otype\":0}', '0', '', '2020-05-22 14:46:22');
INSERT INTO `sys_oper_log` VALUES ('495', '资源文件新增数据', '0', '/module/rmp_file/add', 'POST', '1', 'admin', '', '/module/rmp_file/add', '[::1]', '内网IP', '{\"FileName\":\"23123\",\"FileExt\":\"\",\"StoreList\":\"\",\"PrevFilePic\":\"c2x20vogiy8k895965.png\",\"PrevFileVideo\":\"c2x212mcffl8508683.mp4\",\"RmpTypeId\":2,\"MetaData\":\"\",\"PathId\":100000,\"IsPackage\":\"\",\"ParentId\":0,\"Status\":0,\"DelFlag\":0,\"Remark\":\"\",\"Rmpfile\":\"c2x219cgzwco919906.png\"}', '{\"code\":0,\"msg\":\"操作成功\",\"data\":6,\"otype\":0}', '0', '', '2020-05-22 14:49:49');
INSERT INTO `sys_oper_log` VALUES ('496', '资源文件新增数据', '0', '/module/rmp_file/add', 'POST', '1', 'admin', '', '/module/rmp_file/add', '[::1]', '内网IP', '{\"FileName\":\"23123\",\"FileExt\":\"\",\"StoreList\":\"\",\"PrevFilePic\":\"c2x20vogiy8k895965.png\",\"PrevFileVideo\":\"c2x212mcffl8508683.mp4\",\"RmpTypeId\":2,\"MetaData\":\"\",\"PathId\":100000,\"IsPackage\":\"\",\"ParentId\":0,\"Status\":0,\"DelFlag\":0,\"Remark\":\"\",\"Rmpfile\":\"c2x219cgzwco919906.png\"}', '{\"code\":0,\"msg\":\"操作成功\",\"data\":7,\"otype\":0}', '0', '', '2020-05-22 14:49:55');
...
-- Records of sys_post
-- ----------------------------
INSERT INTO `sys_post` VALUES ('1', 'ceo', '董事长', '1', '1', 'admin', '2018-03-16 11:33:00', '', '2020-05-20 17:35:59', '4223434');
INSERT INTO `sys_post` VALUES ('2', 'se', '项目经理', '2', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', '');
INSERT INTO `sys_post` VALUES ('3', '22', '232', '22222', '0', 'admin', '2020-05-20 17:36:17', '', null, '2222222222');
INSERT INTO `sys_post` VALUES ('4', '调度', '4444', '22222', '0', 'admin', '2020-05-20 17:36:29', '', null, '2222222222');
...
INSERT INTO `sys_role` VALUES ('8', '管事的', 'user', '0', '1', '0', '0', 'admin', '2020-05-20 17:37:08', '', null, '1');
...
INSERT INTO `sys_user` VALUES ('5', '112', '123456', '123456', '', 'jam@gmail.com', '15342050992', '0', '', '635fbb512905f5be73c5655c05378885', 'MMMMMM', '0', '0', '', null, 'admin', '2020-05-20 17:33:56', '', null, '');
...
INSERT INTO `sys_user_online` VALUES ('C2TIH198MJJODSSEV6', 'admin', '', '[::1]', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2020-05-18 17:32:28', '2020-05-18 17:32:28', '1440');
INSERT INTO `sys_user_online` VALUES ('C2TRWN5RR1SCIUSJNN', 'admin', '', '[::1]', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2020-05-22 10:08:23', '2020-05-22 10:08:23', '1440');
